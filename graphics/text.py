...
class Text(QGraphicsTextItem, Containable, CollisionResponsive, DragDroppable, Snappable, HasContextMenu, Deletable):
    ...
    def __init__(self, html:str=None):
        ...
        if html is  not None:            
            self.setHtml(html)
        self.setFlags(self.ItemIsFocusable | self.ItemIsMovable | self.ItemSendsGeometryChanges | self.ItemIsSelectable | self.ItemSendsScenePositionChanges)
